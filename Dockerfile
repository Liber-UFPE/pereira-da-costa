FROM eclipse-temurin:21.0.10_7-jdk-jammy@sha256:9119073a0b783fd380fbf4b131a40955525c8e2a66083681c87fb15a39ae01d0 AS build
...
EXPOSE 8080
HEALTHCHECK CMD curl -f "http://localhost:$PEREIRA_DA_COSTA_PORT/" || exit 1
...
RUN addgroup --system pereira-da-costa && adduser --system -G pereira-da-costa pereira-da-costa
USER pereira-da-costa
