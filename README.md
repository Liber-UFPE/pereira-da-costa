...
![Main Workflow](https://github.com/Liber-UFPE/pereira-da-costa/actions/workflows/main.yml/badge.svg?branch=main)
...
- [ ] Replace `pereira-da-costa`, `PROJECT_STARTER` (and other mentions) with your project's name
